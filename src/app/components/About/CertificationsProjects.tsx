...
export default function CertificationsProjects() {
  ...
  return (
    <section className="mx-auto mt-20 w-full max-w-6xl space-y-10 px-2 sm:px-6 lg:px-0">
      <motion.h2
      ...
      <div className="grid w-full gap-6 md:grid-cols-2 md:gap-10">
        ...
        >
          <div className="relative w-full flex-1 rounded-2xl border border-gray-700 bg-gray-800/50 p-6 text-gray-300 shadow-lg backdrop-blur-md transition-all duration-500 hover:border-purple-500 hover:bg-cyan-500/10">
              ...
              {certificates.map((cert, i) => (
                ...
                >
                  <div className="flex flex-col">
                    <p className="text-sm font-medium text-purple-400 sm:text-base">
                      {cert.title}
                    </p>
            ...
            <ul className="space-y-4 text-gray-300">
              {projects.map((project, i) => (
                <li
                  key={i}
                  className={`pb-3 ${
                    i !== projects.length - 1 ? 'border-b border-gray-700' : ''
                  }`}
                >
